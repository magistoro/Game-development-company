...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('adminlte/plugins/bootstrap-switch/css/bootstrap3/bootstrap-switch.min.css')); ?>">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo e(route('admin.index')); ?>" class="brand-link">
      ...
      <span class="brand-text font-weight-light ml-3">KitTV PRO</span>
    </a>
 ...
 <div class="form-inline pt-3">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-<?php echo e(now()->year); ?> <a href="<?php echo e(route('admin.index')); ?>">KitTV</a>.</strong>
    Все права защищены
...
<script src="<?php echo e(asset('adminlte/plugins/datatables-searchpanes/js/searchPanes.bootstrap4.min.js')); ?>"></script>
<script src="<?php echo e(asset('adminlte/plugins/datatables-bs4/js/dataTables.bootstrap4.min.js')); ?>"></script>
...
<script>
  ...
  $('#is_published').on('switchChange.bootstrapSwitch', function(event, state) {
  var newValue = state ? 1 : 0;
  $(this).prop('checked', state); // Обновляем состояние переключателя
  $('#is_published_status').val(newValue); // Обновляем значение в атрибуте value
  });
  var value = $('#is_published_status').val();
  $('#is_published').bootstrapSwitch('state', value == 1); // Установите состояние переключателя в зависимости от значения


 // Проверяем, была ли таблица уже инициализирована
 if (!$.fn.DataTable.isDataTable('#example1')) {
      // Активация DataTables
      $('#example1').DataTable({
        language: {
        search: "Поиск:",
...
<?php /**PATH C:\Users\maksi\Desktop\Мои_сайты\kitprotv\resources\views/layouts/admin.blade.php ENDPATH**/ ?>