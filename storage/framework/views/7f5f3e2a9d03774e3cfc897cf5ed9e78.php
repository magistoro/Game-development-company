                ...
                <header style="position: absolute; top: 10px; left: 0; width: 100%; padding: 5px;">
                    ...
                    <nav style="position: absolute; top: 30px; left: 490px; font-family: Roboto, sans-serif; font-size: 24px; font-weight: 500;">
                        <ul style="list-style: none; padding: 0;">
                            <li style="display: inline; margin-right: 30px;">Игры</li>
                            <li style="display: inline; margin-right: 30px;">Мерч</li>
                            <li style="display: inline; margin-right: 30px;">Форум</li>
                            <li style="display: inline; margin-right: 30px;">Работа с нами</li>
                        </ul>
                    </nav>
                    <div style="position: absolute; top: 30px; right: 100px;">
                        <img src="Content/Index/user-icon.png" alt="User" style="margin-right: 40px;">
...
.console-underscore {
 ...
 <!-- Charming -->
<script src="<?php echo e(asset('adminlte/plugins/charming/charming.min.js')); ?>"></script>
<script src="<?php echo e(asset('adminlte/plugins/charming/imagesloaded.pkgd.min.js')); ?>"></script>
<script src="<?php echo e(asset('adminlte/plugins/charming/nearby.js')); ?>"></script>
<script src="<?php echo e(asset('adminlte/plugins/charming/TweenMax.min.js')); ?>"></script>
<script>
...
<?php echo $__env->make('layouts.imports', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\maksi\Desktop\Мои_сайты\culinary-game\resources\views/API/home.blade.php ENDPATH**/ ?>